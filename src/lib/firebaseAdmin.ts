...
const firebaseConfig = {
  projectId: process.env.FIREBASE_PROJECT_ID || 'at-taqwa-app-14b7f',
  clientEmail: process.env.FIREBASE_CLIENT_EMAIL || 'firebase-adminsdk-fbsvc@at-taqwa-app-14b7f.iam.gserviceaccount.com',
